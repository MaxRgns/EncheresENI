...
<body>
	...
	<label>Début de l'enchère :</label><input type="date" name = "dateD" value="${now}"><input type="time" name = "timeD" value="${now}"><br>
	<label>Fin de l'enchère :</label><input type="date" name = "dateF" required><input type="time" name = "timeF" required><br>
	<fieldset>
